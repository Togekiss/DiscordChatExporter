        ...
        new Dictionary<string, string>
        {
            ...
            [nameof(PersistTokenTooltip)] = """
                ...
                **Увага**: хоча токен зберігається із шифруванням, він може бути відновлений зловмисником, який має доступ до вашої системи.
                """,
            [nameof(ShowPositionsLabel)] = "Показувати позиції",
            [nameof(ShowPositionsTooltip)] =
                "Показувати або приховувати номери позицій у списку каналів.",
            [nameof(RelativePositionsLabel)] = "Відносні позиції",
            [nameof(RelativePositionsTooltip)] =
                "Використовувати відносні позиції (починаючи з 1 у кожній категорії) замість загальносерверних позицій.",
            ...
            [nameof(OutputPathTooltip)] = """
                ...
                **%C** — назва каналу
                **%p** — позиція каналу
                **%P** | **%N** — позиція категорії
                **%a** — дата після
                **%b** — дата до
                **%d** — поточна дата
                """,
            [nameof(ThreadsOutputPathLabel)] = "Шлях збереження потоків",
            [nameof(ThreadsOutputPathTooltip)] = """
                Шлях до файлу або директорії виводу для потоків.

                Якщо не вказано, шляхи та імена файлів потоків будуть генеруватись на основі основного шляху виводу.
